...
<footer id="footer" class="clearfix">
	...
	<div id="protected-gallery" class="dark clearfix">
        ...
        <form name="login-password" method="post">
        <label>Please enter ID:</label>
        <input class="inputPass" name="passwordfield" type="password">
        <input class="botonPass" type="submit" name="submitpwd" value="Submit">
        </form>
