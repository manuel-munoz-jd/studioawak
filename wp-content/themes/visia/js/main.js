...
function initializeVisia() {
	...
	jQuery('#contact-open').click(function (e) {
		...
		if ( jQuery('#contact-form').is(':hidden') ) {
			jQuery('#protected-gallery').slideUp();
	...
	//PROTECTED-GALLERY
	jQuery('#protected-open').click(function (e) {
		e.preventDefault();
		if ( jQuery('#protected-gallery').is(':hidden') ) {
			jQuery('#contact-form').slideUp();
			jQuery('#protected-gallery').show();
			jQuery('html, body').animate({ 
				scrollTop: jQuery('#protected-gallery').offset().top 
			}, 1500);
		} else {
			jQuery('#protected-gallery').slideUp();
		}
	...
	jQuery('#access').submit(function(e){
		e.preventDefault();
	});
